...
#ifdef USE_QWINDOW
    QScreen* screen;
    Window* window = nullptr;		// Display window object
#else
    xcb_screen_t *screen;
    xcb_window_t window;
#endif
...
#ifdef USE_QWINDOW
        void show();
        void setScreen(QScreen* targetScreen);
#endif
...
#define VULKAN_EXAMPLE_MAIN()																		\
    ...
    {                                                                                     			\
       QApplication qtApp(argc, argv);																\
        ...
        vulkanExample->setScreen(QGuiApplication::primaryScreen());									\
        vulkanExample->initVulkan();																\
        vulkanExample->setupWindow();																\
        vulkanExample->prepare();                   												\
        vulkanExample->show();																		\
...
#define VULKAN_EXAMPLE_MAIN_MULTIPLE_WINDOWS()														\
    int main(int argc, char **argv)								                					\
    {                                                                                     			\
       QApplication qtApp(argc, argv);																\
                                                                                                    \
        ...
        VulkanExample* vulkanExample2 = new VulkanExample(); 										\
        {                                                                                           \
        vulkanExample2->setScreen(QGuiApplication::primaryScreen());								\
        vulkanExample2->initVulkan();																\
        vulkanExample2->setupWindow();																\
        vulkanExample2->prepare();                   												\
        }                                                                                           \
        																							\
    	layout->addWidget(QWidget::createWindowContainer(vulkanExample->window)); 					\
    	layout->addWidget(QWidget::createWindowContainer(vulkanExample2->window)); 					\
